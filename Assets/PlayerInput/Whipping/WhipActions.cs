...
public partial class @WhipActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IWhippingActions> m_WhippingActionsCallbackInterfaces = new List<IWhippingActions>();
    ...
    public struct WhippingActions
    {
        ...
        public void AddCallbacks(IWhippingActions instance)
        {
            if (instance == null || m_Wrapper.m_WhippingActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_WhippingActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IWhippingActions instance)
        {
            @Whip.started -= instance.OnWhip;
            @Whip.performed -= instance.OnWhip;
            @Whip.canceled -= instance.OnWhip;
        ...
        public void RemoveCallbacks(IWhippingActions instance)
        {
            if (m_Wrapper.m_WhippingActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IWhippingActions instance)
        {
            foreach (var item in m_Wrapper.m_WhippingActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_WhippingActionsCallbackInterfaces.Clear();
