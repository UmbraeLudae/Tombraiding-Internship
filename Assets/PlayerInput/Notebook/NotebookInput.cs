...
public partial class @NotebookInput : IInputActionCollection2, IDisposable
{
    ...
    private INotebookActions m_NotebookActionsCallbackInterface;
    ...
    public struct NotebookActions
    {
        ...
        {
            if (m_Wrapper.m_NotebookActionsCallbackInterface != null)
            {
                @OpenClose.started -= m_Wrapper.m_NotebookActionsCallbackInterface.OnOpenClose;
                @OpenClose.performed -= m_Wrapper.m_NotebookActionsCallbackInterface.OnOpenClose;
                @OpenClose.canceled -= m_Wrapper.m_NotebookActionsCallbackInterface.OnOpenClose;
                @CyclePages.started -= m_Wrapper.m_NotebookActionsCallbackInterface.OnCyclePages;
                @CyclePages.performed -= m_Wrapper.m_NotebookActionsCallbackInterface.OnCyclePages;
                @CyclePages.canceled -= m_Wrapper.m_NotebookActionsCallbackInterface.OnCyclePages;
            }
            m_Wrapper.m_NotebookActionsCallbackInterface = instance;
            if (instance != null)
            {
